...
author: "Andreas Brandsegg Kandidat 23"
format: pdf
editor: visual
---
...
SVAR:\
Ligning 4 representerer prisindeksen over 12 måneder.

Vi,t-12 viser til vekten av en varegruppe i for perioden t-12 som er 12 måneder tilbake i tid.

DeltaPi,t viser til endringen i prisen for varegruppen i fra t-12 til 12.\
Kan skrives som Pi,t - Pi,t-12 viser da en endringen i prisen fra ett år tidligere.

Når du ganger de to sammen får du KPIen til varegruppen i.

Pt-12 under brøkstreken representerer den totale KPIen ett år tilbake.

Den samlede brøken viser at å dele resultatet fra i over brøken med Pt-12 får du i sitt bidrag til KPIen fra forrige år.

Du ganger den med 100 for å få det til en prosentandel.

Det viser hvordan varegruppe i bidrar til inflasjonen over 12 måneder i prosent.
...
Her har jeg gått glipp av noe, og klarte ikke å hente ut/regne meg til de rette verdiene og får ikke til oppgaven.

HINT!!

Hente ut konsumgruppe(matvarer og alkoholfrie drikkevarer)

Jeg har brukt notater fra forelesning, GIThubCOpilot og ChatGPT som hjelpemidler i dette arbeidskravet.
